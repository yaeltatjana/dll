...
void AlexNet::setConvLayer(size_t layer, size_t channel, size_t dim1, size_t dim2, size_t nbFilt, size_t filt1,
                           size_t filt2) {
    switch (layer) {
        case 0:
            ...
            break;
        case 2:
            net->template layer_get<2>().init_layer(channel, dim1, dim2, nbFilt, filt1, filt2);
            break;
        case 4:
            net->template layer_get<4>().init_layer(channel, dim1, dim2, nbFilt, filt1, filt2);
            break;
        case 5:
            net->template layer_get<5>().init_layer(channel, dim1, dim2, nbFilt, filt1, filt2);
            break;
        case 6:
...
void AlexNet::setMPLayer(size_t layer, size_t channel, size_t dim1, size_t dim2, size_t pool1, size_t pool2) {
    switch (layer) {
        case 1:
            net->template layer_get<1>().init_layer(channel, dim1, dim2, pool1, pool2);
            break;
        case 3:
            net->template layer_get<3>().init_layer(channel, dim1, dim2, pool1, pool2);
            break;
        case 7:
            net->template layer_get<7>().init_layer(channel, dim1, dim2, pool1, pool2);
            break;
    }
}
