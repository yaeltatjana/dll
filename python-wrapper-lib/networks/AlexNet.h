...
/**
 * Type of AlexNet network
 */
using dbn_alexnet = dll::dbn_desc<dll::dbn_layers <
...
/**
 * Class to use the AlexNet network
 */
class AlexNet {
    std::unique_ptr <dbn_alexnet> net;  ///< The network

public:
    /**
     * Constructor for the AlexNet
     */
    AlexNet();
    ...
    /**
     * Change adam_beta1 value
     * @param beta  adam_beta1 value
     */
